...
class GodRig(module.RigModule, object):
    ...
    def create(self, character_name, *args, **kwargs):
        super(GodRig, self).create(character_name, *args, **kwargs)

        control_data = self.control_data if self.has_attr('control_data') and self.control_data else None
